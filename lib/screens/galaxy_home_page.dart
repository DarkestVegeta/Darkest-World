  ...
  @override Widget build(BuildContext context) => Scaffold(
    ...
    body: Focus(
      ...
      child: Stack(fit: StackFit.expand, children: [
        ...
        if (command) Positioned.fill(child: Material(
...
class Atlas extends StatelessWidget {
  final List<GalaxyWorld> worlds; final Set<GalaxyWorldKind> visited; final GalaxyWorldKind? selected;
  final VoidCallback close; final ValueChanged<GalaxyWorld> open;
