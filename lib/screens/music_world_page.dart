...
class MusicWorldPage extends StatelessWidget {
  final String title;
          ...
          return Stack(
            ...
            children: [
              ...
              SizedBox(
                ...
                height: size,
                child: CustomPaint(
                  painter: const _MusicPlanetPainter(),
                  child: const Center(
                    child: Text(
                      'MUSIC\nWORLD',
    ...
    canvas.drawCircle(
      ...
      Paint()
        ..shader = RadialGradient(
          colors: [
            const Color(0xFF55439A).withValues(alpha: .18),
            Colors.transparent,
          ],
    ...
    canvas.drawCircle(
      ...
      Paint()
        ..shader = const RadialGradient(
          ...
          radius: .95,
          colors: [Color(0xFF302D4B), Color(0xFF151427), Color(0xFF060611)],
