...
class _ArtStage extends StatelessWidget { final String? url; final String title; final double phase; const _ArtStage({required this.url, required this.title, required this.phase}); @override Widget build(BuildContext context) => Stack(children: [ Positioned.fill(child: CustomPaint(painter: _ArtStagePainter(phase))), Positioned.fill(child: Padding(padding: const EdgeInsets.all(24), child: Center(child: _ArtObject(url: url, title: title)))), Positioned(left: 16, top: 14, child: _StageLabel(text: 'ARCHIVE OBJECT')), Positioned(right: 16, top: 14, child: _StageLabel(text: '01 / 01')), Positioned(left: 16, bottom: 14, child: _StageLabel(text: 'TRANSPARENT ART READY')), Positioned(right: 16, bottom: 14, child: _StageLabel(text: 'CURRENT')) ]); }
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      gridDelegate: SliverGridDelegateWithMaxCrossAxisExtent(
        maxCrossAxisExtent: compact ? 190 : 260,
        mainAxisExtent: compact ? 120 : 145,
        crossAxisSpacing: 10,
        mainAxisSpacing: 10,
      ),
      itemBuilder: (_, i) {
            ...
            child: Row(
              children: [
                SizedBox(
                  ...
                  child: url == null
                      ? const Icon(Icons.public, color: Color(0x447F70B0))
                      : Image.network(
                          url,
                          fit: BoxFit.contain,
                          errorBuilder: (_, __, ___) => const Icon(Icons.public, color: Color(0x447F70B0)),
                        ),
                ),
                Expanded(
                  child: Padding(
                    ...
                    child: Text(
                      ...
                      style: const TextStyle(fontSize: 9, letterSpacing: .7, color: Color(0xCCFFFFFF)),
                    ),
                  ),
                ),
              ],
