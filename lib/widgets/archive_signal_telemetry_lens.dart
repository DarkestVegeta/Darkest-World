...
class _ContinuityRail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final telemetry = DarkestWorldArchiveTelemetry.fromNavigation(state);
    final slots = <String>[telemetry.previousActionLabel, telemetry.currentActionLabel.toUpperCase(), telemetry.nextActionLabel];
