...
class _PlanetPainter extends CustomPainter {
  ...
  static const List<Color> _palette = [
    Color(0xFF8E7865), Color(0xFF647C82), Color(0xFF857E67),
    Color(0xFF75677F), Color(0xFF70877A), Color(0xFF7D7063),
  ];
...
class _GalaxyVeil extends CustomPainter {
  ...
  @override void paint(Canvas canvas, Size size) {
    final short = math.min(size.width, size.height); final center = Offset(size.width * .5, size.height * .5);
    final rect = Rect.fromCenter(center: center, width: size.width * .78, height: short * .31); final drift = math.sin(phase * math.pi * 2) * .035;
